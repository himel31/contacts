...
use Contact\UserBundle\Entity\User;
use Contact\UserBundle\Form\UserType;
...
class UserRESTController extends VoryxController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('ContactUserBundle:User')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                return $entities;
            }
